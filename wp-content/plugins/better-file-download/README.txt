...
If you do like what I have created here why not throw a dollar or two into my PayPal account? A little encouragement goes a VERY long way and provides the incentive to keep working on making Better File Download even better.
...
= 1.0.7 =
* Added a "Latest Downloads" short code to allow users to display a finite number of their latest and greatest downloads.

= 1.0.8 =
* Fixed a missing closing style tag that was causing issues for users when setting custom colours.

= 1.0.9 =
* Added default ordering to category downloads and fixed an issue with forcing the download to open in a new tab.

= 1.0.10 =
* Fixed an issue with MP3 files not downloading. Basic security updates.

= 1.0.11 =
* Fixed an issue with downloading VS opening in new tab.

= 1.0.12 =
* Fixed an issue with variable dump accidentaly left in production code. Sorry :(
