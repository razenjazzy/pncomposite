	...
	<div class="bfd-single-row">
		...
		<?php
		 ...
		 <div class="bfd-column bfd-single-button-container">
		 		<?php
		 	if ( isset( $bfd_options['bfd-force-new-tab'] ))
		 	{
		 		?>
		 		<a href="<?php echo get_permalink( $bfd_args['id'] ); ?>" title="<?php echo esc_attr( $bfd_title ); ?>" class="bfd-svg-container bfd-single-download-btn" target="_blank" >
		...
		?>
		 ...
		 <div class="bfd-column">
		 	<a href="<?php echo get_permalink( $bfd_args['id'] ); ?>" title="<?php echo esc_attr( $bfd_title ); ?>" class="bfd-download-meta" <?php echo ( isset( $bfd_options['bfd-force-new-tab'] ) ? 'target="_blank"' : 'download' )  ?> >
