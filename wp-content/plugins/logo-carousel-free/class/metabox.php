...
class SPLC_MetaBox {
	...
	public function enqueue_admin_styles() {
		wp_enqueue_style( 'splc-admin-style', SP_LC_URL . 'admin/assets/css/admin.css', false, SP_LC_VERSION );
		...
		if ( 'wpl_lcp_shortcodes' === get_current_screen()->id || 'wpl_logo_carousel' === get_current_screen()->id ) {
			...
			wp_enqueue_style( 'splc-metabox-style', SP_LC_URL . 'admin/assets/css/wpl-metabox.css', false, SP_LC_VERSION );
	...
	public function admin_scripts() {
		...
		if ( 'wpl_lcp_shortcodes' === get_current_screen()->id ) {
			wp_enqueue_script( 'splc-shortcode-tabs', SP_LC_URL . 'admin/assets/js/admin.js', array(
				'jquery',
				'wp-color-picker'
			), SP_LC_VERSION, true );
		}
