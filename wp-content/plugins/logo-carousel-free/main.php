...
if ( ! class_exists( 'SP_Logo_Carousel' ) ) {
	class SP_Logo_Carousel {
		...
		function public_scripts() {
				// CSS Files.
				wp_register_style( 'sp-lc-slick', SP_LC_URL . 'public/assets/css/slick.css', array(), SP_LC_VERSION );
				wp_register_style( 'sp-lc-font-awesome', SP_LC_URL . 'public/assets/css/font-awesome.min.css', array(), SP_LC_VERSION );
				wp_register_style( 'sp-lc-style', SP_LC_URL . 'public/assets/css/style.css', array(), SP_LC_VERSION );

				// JS Files.
				wp_register_script( 'sp-lc-slick-js', SP_LC_URL . 'public/assets/js/slick.min.js', array( 'jquery' ), SP_LC_VERSION, true );
				wp_register_script( 'sp-lc-script', SP_LC_URL . 'public/assets/js/splc_script.js', array( 'jquery', 'sp-lc-slick-js' ), SP_LC_VERSION, true );
		}
