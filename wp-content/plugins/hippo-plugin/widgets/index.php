	...
	class Hippo_Recent_Post_Widget extends WP_Widget {
		public function __construct() {
			parent::__construct(
				...
				sprintf( esc_html__( '%s :: Recent Posts', 'hippo-plugin' ), HIPPO_THEME_NAME ), // Name
				array( 'description' => esc_html__( 'Show off recent post with thumb', 'hippo-plugin' ), ) // Args
			);
		}
		...
		public function form( $instance ) {
			...
			<p>
				<?php esc_html_e( 'Thumbnail Image Size:', 'hippo-plugin' ); ?>
			</p>
	...
	class Hippo_Latest_Tweet_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( esc_html__( '%s :: Latest Tweets', 'hippo-plugin' ), HIPPO_THEME_NAME ), // Name
				array( 'description' => esc_html__( 'Displays latest tweet in any sidebar', 'hippo-plugin' ) ) // Args
			);
		...
		public function scripts() {
			wp_enqueue_script( 'hippo-twitter-fetcher', HIPPO_PLUGIN_URL . 'widgets/js/twitter-fetcher-min.js', array( 'jquery' ), NULL, TRUE );
			wp_enqueue_script( 'hippo-twitter-fetcher-config', HIPPO_PLUGIN_URL . 'widgets/js/twitter-fetcher-config.js', array(
				'jquery',
				'hippo-twitter-fetcher'
			), NULL, TRUE );
		}
		...
		public function form( $instance ) {
			...
			<p>
				...
				<small>
					e.g: 567185781790228482,
					<br> Login to twitter and <a target="_blank" href="https://twitter.com/settings/widgets/">Create New
						widget</a>. Save It, Copy <strong>18-digit number from browser address bar</strong> and paste it
					here.
				</small>
			</p>
	...
	class Hippo_Flickr_Photo_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( esc_html__( '%s :: Flickr Photo', 'hippo-plugin' ), HIPPO_THEME_NAME ), // Name
		...
		public function scripts() {
			wp_enqueue_script( 'hippo-flicker-photo', HIPPO_PLUGIN_URL . 'widgets/js/flicker-photo.min.js', array( 'jquery' ), NULL, TRUE );
			wp_enqueue_script( 'hippo-flicker-photo-config', HIPPO_PLUGIN_URL . 'widgets/js/flicker-photo-config.js', array(
				'jquery',
				'hippo-flicker-photo'
			), NULL, TRUE );
		}
