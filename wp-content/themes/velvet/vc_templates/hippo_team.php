<?php
	...
	<div class="hippo-team-wrapper <?php echo esc_attr( $css_class ); ?>">
		<?php
			echo wp_get_attachment_image( $attributes[ 'image' ], 'velvet-team-photo', FALSE, array(
				'class' => "attachment-velvet-team-photo size-velvet-team-photo hippo-team-image img-responsive",
